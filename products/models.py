...
class Product_Model(models.Model):
    status_options = [("Sale","Sale"),("New","New"),("Out of Stock","Out of Stock")]
    ...
    image3 = models.ImageField(upload_to="products", default="def_product.jpg")
    image4 = models.ImageField(upload_to="products", default="def_product.jpg")
